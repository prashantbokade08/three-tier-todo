...
var MONGO_URI = "mongodb://localhost:27017/todo-app";
// Middleware
...
app.post("/api/todos", function (req, res) { return __awaiter(void 0, void 0, void 0, function () {
    var todo, newTodo, err_2, errorMessage;
    return __generator(this, function (_a) {
        switch (_a.label) {
            case 0:
                todo = new Todo({
...
app.get("/api/todos/:id", function (req, res) { return __awaiter(void 0, void 0, void 0, function () {
    var todo, err_3, errorMessage;
    return __generator(this, function (_a) {
        switch (_a.label) {
            case 0:
                _a.trys.push([0, 2, , 3]);
                return [4 /*yield*/, Todo.findById(req.params.id)];
            case 1:
                todo = _a.sent();
                if (!todo) {
...
app.patch("/api/todos/:id", function (req, res) { return __awaiter(void 0, void 0, void 0, function () {
    var todo, updatedTodo, err_4, errorMessage;
    return __generator(this, function (_a) {
        switch (_a.label) {
            case 0:
                _a.trys.push([0, 3, , 4]);
...
app.delete("/api/todos/:id", function (req, res) { return __awaiter(void 0, void 0, void 0, function () {
    ...
    return __generator(this, function (_a) {
        switch (_a.label) {
            case 0:
                _a.trys.push([0, 2, , 3]);
                return [4 /*yield*/, Todo.deleteOne({ _id: req.params.id })];
            case 1:
                result = _a.sent();
